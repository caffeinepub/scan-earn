...
export class Backend implements backendInterface {
    ...
    async addFunds(arg0: string, arg1: bigint, arg2: string | null, arg3: ExternalBlob | null): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.addFunds(arg0, arg1, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2), await to_candid_opt_n9(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminApprovePayment(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async adminDeclinePayment(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminDeclinePayment(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminGetAllPaymentRequests(): Promise<Array<PaymentRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetAllPaymentRequests();
    ...
    async adminGetAllUserMessages(): Promise<Array<UserMessageThread>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetAllUserMessages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminGetAllUsers(): Promise<Array<Principal>> {
        if (this.processError) {
            try {
    ...
    async adminGetBlockedUsers(): Promise<Array<Principal>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetBlockedUsers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminGetFlaggedPayments(): Promise<Array<PaymentRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetFlaggedPayments();
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminGetPendingPayments(): Promise<Array<PaymentRequest>> {
        if (this.processError) {
            try {
    ...
    async adminGetUserMessages(arg0: Principal): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetUserMessages(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminIsUserBlocked(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.adminIsUserBlocked(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminReplyToUser(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminReplyToUser(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAddFundsHistory(): Promise<Array<Transaction>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAddFundsHistory();
    ...
    async getWithdrawalHistory(): Promise<Array<Transaction>> {
        if (this.processError) {
            try {
    ...
    async isAvailableForAnonymous(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.isAvailableForAnonymous();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PaymentRequest_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PaymentRequest): Promise<PaymentRequest> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        receipt: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.receipt)),
        flagReason: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.flagReason)),
        user: value.user,
        submittedAt: value.submittedAt,
        utrId: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.utrId)),
        amount: value.amount,
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? PaymentStatus.pending : "approved" in value ? PaymentStatus.approved : "declined" in value ? PaymentStatus.declined : value;
}
function from_candid_variant_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "addFunds" in value ? TransactionType.addFunds : "withdrawal" in value ? TransactionType.withdrawal : value;
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PaymentRequest>): Promise<Array<PaymentRequest>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PaymentRequest_n12(_uploadFile, _downloadFile, x)));
}
